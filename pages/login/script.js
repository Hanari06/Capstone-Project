function login() {
    ...
    $.ajax({
        ...
        "success" : function (response) { //success yung response
            ...
            if(parseResponse.description == "Wrong Password please try again")
            {
                description = "Mali ang pasword. Ulitin muli";
                bgcolor = "alert alert-warning";

            }
            if(parseResponse.description == "Account doesn't exist")
            {
                description = "Ang iyong account ay wala sa talaan";
